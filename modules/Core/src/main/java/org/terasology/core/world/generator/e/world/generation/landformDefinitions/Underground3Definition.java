...
public class Underground3Definition extends OldLandFormDefinition implements Noise3D {
    ...
    public Underground3Definition(Long seed) {
        ...
        this.noiseList.add(new SubSampledNoise3D(new ValueMultiplicationAdapter(new ValueAdditionAdapter(new BrownianNoise3D(new SimplexNoise(seed), 3), 0.6f), 2f),
