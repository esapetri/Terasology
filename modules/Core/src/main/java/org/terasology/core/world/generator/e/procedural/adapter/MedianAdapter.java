 ...
 * @author Esereja
 */
public class MedianAdapter implements Noise3D,Noise2D {
	 ...
	 * @param kernelSize
	 */
	public MedianAdapter(Noise3D noise,int kernelSize) {
        this.noise3 = noise;
	 ...
	 */
	public MedianAdapter(Noise2D noise,int kernelSize,byte b) {
        this.noise2 = noise;
        this.kernelSize=kernelSize;
    }
