 ...
 * @author Esereja
 */
public class CompineAdapter implements Noise3D,Noise2D {
     ...
     * @param noise2
     */
    public CompineAdapter(Noise3D noise1,Noise3D noise2) {
        this.noise31 = noise1;
        this.noise32 = noise2;
    }
     ...
     * @param b
     */
    public CompineAdapter(Noise2D noise1,Noise2D noise2,byte b) {
        this.noise21 = noise1;
        this.noise22 = noise2;
    }
